                            ...
                            <div class="mb-2 w-96">
                                <div class="bg-white p-4 border border-gray-300 w-full">
                                    <a href="<?php echo e(route('show_order', $order)); ?>">
                                        <h5 class="text-xl font-semibold">Order #<?php echo e($order->id .'_' . $order->created_at->format('dmY')); ?></h5>
                                    </a>
...
<?php endif; ?>
<?php /**PATH C:\xamppbib\htdocs\latihan_ecommerce\resources\views/order/index.blade.php ENDPATH**/ ?>