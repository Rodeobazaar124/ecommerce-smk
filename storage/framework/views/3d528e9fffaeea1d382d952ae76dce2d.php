                        ...
                        <div class="p-5">
                            <a href="<?php echo e(route('product.show', $product)); ?>">
                                <h5 class="mb-2 text-sm sm:text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                    ...
                                    <span class="text-gray-700 dark:text-gray-400"><?php if (isset($component)) { $__componentOriginal8eb618690d560649124b2702e9f6c82e = $component; } ?>
...
<?php endif; ?></span>
                            ...
                            <p class="mb-3 text-sm font-normal sm:text-base text-gray-700 dark:text-gray-400"><?php echo e(Str::limit($product->description, $limit = 32, $end = '...')); ?></p>
                            <a href="<?php echo e(route('product.show', $product)); ?>"
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\e-commerce-pwpb\resources\views/product/index_user.blade.php ENDPATH**/ ?>