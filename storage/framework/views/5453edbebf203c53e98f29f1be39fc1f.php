...
<?php endif; ?>
                            ...
                            <form action="<?php echo e(route('destroy.cart', $cart)); ?>" method="post" class="mt-1">
...
<?php $component->withAttributes([]); ?>
                ...
                <p>Total: <?php if (isset($component)) { $__componentOriginal8eb618690d560649124b2702e9f6c82e = $component; } ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($total_price)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?></p>
                ...
                <p>Diskon: <?php if (isset($component)) { $__componentOriginal8eb618690d560649124b2702e9f6c82e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8eb618690d560649124b2702e9f6c82e = $attributes; } ?>
<?php $component = App\View\Components\Idr::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('idr'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($discount)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal8eb618690d560649124b2702e9f6c82e)): ?>
<?php $attributes = $__attributesOriginal8eb618690d560649124b2702e9f6c82e; ?>
...
<?php unset($__componentOriginal8eb618690d560649124b2702e9f6c82e); ?>
<?php endif; ?></p>
                <p>Total Bayar: <?php if (isset($component)) { $__componentOriginal8eb618690d560649124b2702e9f6c82e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8eb618690d560649124b2702e9f6c82e = $attributes; } ?>
<?php $component = App\View\Components\Idr::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('idr'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($total_bayar)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal8eb618690d560649124b2702e9f6c82e)): ?>
<?php $attributes = $__attributesOriginal8eb618690d560649124b2702e9f6c82e; ?>
...
<?php endif; ?></p>
                <form action="<?php echo e(route('checkout')); ?>" method="post">
                    ...
                    <button
                        ...
                        type="submit" <?php echo e($carts->isEmpty() ? 'disabled' : ''); ?>>Checkout</button>
                </form>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal740c66ff9bbfcb19a96a45ba2fa42d64)): ?>
...
<?php endif; ?>
<?php /**PATH C:\xamppbib\htdocs\latihan_ecommerce\resources\views/cart/index.blade.php ENDPATH**/ ?>