<x-app-layout>
    <header class="h-screen bg-gradient-to-b from-blue-300 to-gray-100 dark:from-gray-600 dark:to-gray-900">
        <div class="container mx-auto sm:px-4 py-16 text-center">
            ...
            <p class="text-gray-900 dark:text-white font-medium text-xl mb-8">
                {{ request('query')
                    ? 'Hasil Pencarian dari ' . request('query')
                    : 'Find the best selection of quality computer
    ...
    <div class="{{ !request('query') ? '-mt-96' : '-mt-[26rem]'}} pb-10">
        <x-card>
            @if ($products->total() > 0)
